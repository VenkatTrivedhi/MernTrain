...
class Student {
    ...
    static createStudent(firstname, lastname, Dob, SGPA, sem_grades, enrolled_year, passed_year){
        ...
        let age = Student.#autoUpdateAge(Dob)
        
        let CGPA = Student.#autoUpdateCGPA(SGPA)
        
        let finaleGrade = Student.#autoUpdateGrade(sem_grades)
       
        let numberofYearsofGraduation = passed_year - enrolled_year

        const  newStudent = new Student(firstname, lastname, fullname, Dob, age, SGPA, CGPA, sem_grades, finaleGrade, enrolled_year, passed_year, numberofYearsofGraduation)
        Student.all_student.push(newStudent)
        return newStudent    
    }
